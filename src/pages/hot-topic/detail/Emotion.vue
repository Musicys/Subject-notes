...
<template>
  <view class="emotion-section">
    <u-tabs :list="tabList" :current="currentTab" lineColor="#FE2C2B" :activeStyle="{ color: '#FE2C2B' }"
      :inactiveStyle="{ color: '#363636' }" @click="handleTabClick">
    </u-tabs>
    <view class="tab-container">
      <view class="chart-block" v-for="(item, index) in chartList" :key="'chart-' + index">
        <CandleChart :id="'chart-' + index" style="width: 100%; height: 400rpx;" :categories="item.categories"
          :series="item.series"></CandleChart>
      </view>
    </view>
  </view>
</template>
